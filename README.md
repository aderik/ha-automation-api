...
Implementation: uses HA Store API (key: automation_api), reloads automations, logs actions to HA system log. REST/WS payloads are validated. GET /api/automation_api/automations lists current HA automations.
